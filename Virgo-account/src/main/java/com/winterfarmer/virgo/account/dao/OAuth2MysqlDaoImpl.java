...
public class OAuth2MysqlDaoImpl extends BaseDao implements OAuth2Dao {
    ...
    public void initTable(boolean dropBeforeCreate) {
        super.initTable(createOauth2AccessTokenDDL, BaseDao.dropDDL(OAUTH2_ACCESS_TOKEN_TABLE_NAME), dropBeforeCreate);
    }
